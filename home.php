...
<body>
    <section class="college-head container d-flex justify-content-center">
        <div class="pt-1">
            <a href=""><img src="./img/school (1).png" alt="" height="80" width="80"></a>
        </div>
        <div class="container pl-4 pt-2 pb-2">
            <h1 class="text-dark  border-bottom border-dark">Andrew College Of Engineering</h1>
            <!-- <hr> -->
            <h6 class="text-dark">Appproved by AICTE:ISO 9001:2015 Certified, Permanently Affiliated to University of
                Mumbai</h6>
        </div>
    </section>
    <nav class="navbar navbar-expand-lg navbar-light bg-dark container-fluid p-0">
        <ul class="navbar-nav mr-auto container-fluid d-flex justify-content-around">
            <li class="nav-item">
                <a class="nav-link text-white h4" href="#">Home </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white h4" href="#">Departments</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item ">
                <a class="nav-link text-white h4" href="#">Contact</a>
            </li>
    </nav>
        ...
        <div class="row justify-content-start">
            <div class="col-md-8 justify-content-start">
                ...
                <p class="p-3">Andrew College Of Engineering (ACE) was established in 1999 with a view to create an
                    ...
                    by our Institute as per the validity period mentioned in their letter (Click here). The institute is
    ...
    <section class="our-section pl-3 container-fluid">
        ...
        <p class="p-2">For UG programme:- “To churn highly competent engineering graduates with a commitment to result
